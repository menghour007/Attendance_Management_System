                    ...
                    <?php if (count($teachers) > 0): ?>
                        <?php foreach ($teachers as $teacher): ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="status <?php echo $teacher['is_active'] == 1 ? 'status-active' : 'status-inactive'; ?>">
                                ...
                                <td>
                                    ...
                                    <a href="index.php?action=delete&id=<?php echo $teacher['id']; ?>" class="btn btn-delete"
                                        onclick="return confirm('Are you sure you want to completely remove this teacher account profile?')">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6" style="text-align: center; color: #7f8c8d;">No teacher profiles found in system.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
